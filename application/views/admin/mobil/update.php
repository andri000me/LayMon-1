        ...
        <div class="col-12">
          <div class="card">
            ...
            <?=form_hidden($csrf['name'],$csrf['hash'])?>
              <div class="card-body">
                <input type="hidden" class="form-control" name="id" value="<?=$id_mobil?>" required>
                <div class="form-group">
                  <label for="inputNopol">No Polisi Mobil</label>
                  <input type="text" class="form-control" name="nopol" id="inputNopol" placeholder="Masukan No Polisi Kendaraan Anda ..." maxlength="10" value="<?=$dataMobil['nopol_mobil']?>" required>
                </div>
                <div class="form-group">
                  <label for="inputMerk">Merk Mobil</label>
                  <input type="text" class="form-control" name="merk" id="inputMerk" placeholder="Masukan Merk Kendaraan Anda ..." maxlength="70" value="<?=$dataMobil['merk_mobil']?>" required>
                </div>
                <div class="form-group">
