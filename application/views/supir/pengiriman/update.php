      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <?=form_hidden('id',$id_mon)?>
              <div class="card-body">
                <div class="form-group">
                  <label for="inputNSurat">No Surat Jalan</label>
                  <input type="text" class="form-control" name="suratjalan" id="inputNSurat" placeholder="Masukan No Surat Jalan Anda ..." maxlength="13" value="<?=$dataPengiriman['kodejalan_mon']?>" required>
                </div>
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="mobil" id="inputMobil" required>
                    ...
                    <option value="<?=$vMobil['id_mobil']?>" <?php if ($vMobil['id_mobil'] === $dataPengiriman['id_mobil']) {echo 'selected';} ?>><?=$vMobil['merk_mobil']?> (<?=$vMobil['nopol_mobil']?>)</option>
                    <?php endforeach;?>
                  </select>
                </div>
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="supir" id="inputSupir" required>
                    ...
                    <option value="<?=$vSupir['id_supir']?>" <?php if ($vSupir['id_supir'] === $dataPengiriman['id_supir']) {echo 'selected';} ?>><?=$vSupir['nama_supir']?></option>
                    <?php endforeach;?>
                  </select>
                </div>
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="pelanggan" id="inputPelanggan" required>
                    ...
                    <option value="<?=$vPelanggan['id_pelanggan']?>" <?php if ($vPelanggan['id_pelanggan'] === $dataPengiriman['id_pelanggan']) {echo 'selected';} ?>><?=$vPelanggan['nama_pelanggan']?></option>
                    <?php endforeach;?>
                  </select>
                </div>
                <div class="form-group">
                  <label for="inputStart">Kordinat Asal</label>
                  <input type="text" class="form-control" name="startkordinat" id="inputStart" placeholder="Masukan Kordinat Asal ..." value="<?=$dataPengiriman['start_mon']?>" required>
                </div>
                <div class="form-group">
                  <label for="inputEnd">Kordinat Tujuan</label>
                  <input type="text" class="form-control" name="endkordinat" id="inputEnd" placeholder="Masukan Kordinat Tujuan ..." value="<?=$dataPengiriman['end_mon']?>" required>
                </div>
              </div>
